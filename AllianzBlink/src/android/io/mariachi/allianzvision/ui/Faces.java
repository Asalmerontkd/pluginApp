...
public class Faces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGraphicOverlay = (GraphicOverlay) findViewById(getResources().getIdentifier("faceOverlay", "id", getPackageName()));

        comenzar = (LinearLayout) findViewById(getResources().getIdentifier("idLayoutComenzarBlink", "id", getPackageName()));
        controles = (LinearLayout) findViewById(getResources().getIdentifier("idLayoutControlesBlink", "id", getPackageName()));
        textoEstado = (TextView) findViewById(getResources().getIdentifier("idTxtOutputBlink", "id", getPackageName()));
        textoContador = (TextView) findViewById(getResources().getIdentifier("txtContador", "id", getPackageName()));
        btnAccept = (ImageView) findViewById(getResources().getIdentifier("btnAcceptBlink", "id", getPackageName()));
        btnRetake = (ImageView) findViewById(getResources().getIdentifier("btnRetakeBlink", "id", getPackageName()));
        ...
        btnRetake.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                controles.setBackgroundColor(getResources().getColor(getResources().getIdentifier("controlBackground", "color", getPackageName())));
                textoEstado.setText("Asegurate que parpadee por un segundo\\nal finalizar la cuent aregresiva");
            }
        });

        backImg = (ImageView) findViewById(getResources().getIdentifier("backFace", "id", getPackageName()));
            ...
            if (initPreview)
            {
                ...
                if (mFaceGraphic.blink() && flag)
                {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), "El usuario parpadeo!!!", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
                    ...
                    if (!estado)
                    {
                        if (blinking)
                        {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    controles.setBackgroundColor(getResources().getColor(getResources().getIdentifier("verde", "color", getPackageName())));
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    controles.setBackgroundColor(getResources().getIdentifier("controlBackgroundRed", "color", getPackageName()));
                                    textoEstado.setText("Algo salió mal, repite el proceso de nuevo, gracias.");
                                }
                            });
                        }
                    }
